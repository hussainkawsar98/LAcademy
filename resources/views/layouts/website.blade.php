...
<html lang="en">
  <head>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,100..900;1,100..900&family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <header id="header">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
              <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('')}}website/images/academy-logo.jpg" class="img-fluid" alt=""></a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown-">
                    <a class="nav-link dropdown-toggle- parent" href="categories.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Categories
                    </a>
                ...
                <div class="d-flex">
                    <a class="nav-link btn primary" href="registration.html">Registration</a>
                    <!-- Login Modal Button -->
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="" method="POST" class="pb-1">
                              ...
                              <p>Don't have an account?<a href="registration.html"><b> Register</b></a></p>
                            </form>
                          </div>
                        </div>
                      </div>
                    </div>
                    <a class="nav-link btn primary ms-2" href="student.html">Hussain</a>
                </div>
              </div>
            </div>
          </nav>
          ...
          <div class="row py-5">
            <div class="col-md-6">
              <div class="footer-single">
                <img src="{{asset('')}}website/Images/academy-logo.png" class="img-fluid" alt="">
                <p class="py-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet natus aperiam illum eos labore quo dolor reiciendis facilis cum deleniti officiis nulla eum sint, sapiente illo mollitia quas assumenda iste.</p>
