  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{url('/')}}" class="brand-link">
        <img src="{{ asset('admin/images/fav.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="{{url('/dashboard/profile')}}" class="d-block">Muktar Hussain</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{url('/dashboard/mentor')}}" class="nav-link">
                <i class="nav-icon fas fa-circle"></i>
                <p>
                  Mentors
                </p>
                ...
                error: function(response) {
                    ...
                    $.each(response.responseJSON.errors, function(field_name, error) {
                        $(document).find("[name=" + field_name + "]")
                            .after('<span class="validation_error" style="color:red">' + error +
                                "</span>");
                        /*   toastr.error(error); */
