...
<head>
  ...
  <title>Laravel Academy Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index.html" class="brand-link">
      <img src="../images/fav.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Muktar Hussain</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="mentor/index.html" class="nav-link">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                Mentors
              </p>
          ...
          <li class="nav-item">
            <a href="student/index.html" class="nav-link">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                Students
              </p>
